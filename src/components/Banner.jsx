    ...
    <section className="min-h-[400px] md:min-h-[500px] flex justify-center items-center text-center">
      <div>
        ...
        <div className="flex flex-wrap justify-center items-center gap-4">
          <Link className="btn btn-primary" onClick={() => scrollTo(0, 0)}>About Us</Link>
          <Link className="btn btn-outline !border-white !text-white hover:!border-primary" onClick={() => scrollTo(0, 0)}>Our Products</Link>
        </div>
      </div>
    </section>
  );
